...
void OnTaskSteal() {
  ...
  steal_count++;
  std::cout << "steals " << steal_count << endl;
}
...
VOID ImageLoad( IMG img, VOID* v) {
  ...
  RTN task_steal_committed = RTN_FindByName( img, "on_task_steal" );
  if (RTN_Valid(task_steal_committed))
  {
    RTN_Replace(task_steal_committed, AFUNPTR(OnTaskSteal));
  }
